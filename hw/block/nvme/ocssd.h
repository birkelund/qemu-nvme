...
#define DEFINE_OCSSD_PROPERTIES(_state, _props) \
    DEFINE_PROP_UINT32("mccap", _state, _props.mccap, 0x0), \
    ...
    DEFINE_PROP_UINT8("early_reset", _state, _props.early_reset, 1), \
...
static inline int ocssd_rw_is_write(NvmeRequest *req)
{
